...
Taking the medication criteria into account.
...
```{r DATA ANA Some simple stuff to get an idea, eval=FALSE}
...
#### Bipolar patients
TODO: Full explanation with literature YMRStot =< 7 or =< 12 etc
